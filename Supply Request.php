...
<main id="main-contentrequest">
    ...
    <div id="left-form-container">
        <form action="Supply Request.php" method="POST" id="request-form">
            ...
            <button type="button" id="view-request-btn" onclick="showProductCards()">View Item Request</button><br>
...
<div id="popup" class="popup">
    ...
    <!-- Available Products Dropdown (will change depending on selection) -->
    <label for="available-products">Available Products:</label>
    <select id="available-products">
        <!-- Default option, will change dynamically -->
    </select>
    <br><br>

    <!-- Options Dropdown (will change depending on selection) -->
    ...
    <!-- Size Dropdown (will change depending on selection) -->
    ...
    <!-- Color Dropdown (will change depending on selection) -->
